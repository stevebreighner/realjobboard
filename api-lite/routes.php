...
return [
  'GET' => [
    ...
    '/api/get-list' => [new JobsController(), 'index'],
    '/api/get-list-detail' => [new JobsController(), 'detail'],
    ...
    '/api/admin/bizdev' => [new AdminController(), 'bizDevList'],
    '/api/admin/recent' => [new AdminController(), 'recentActivity'],
    '/api/user-files' => [new UserFileController(), 'list'],
    '/api/user-file' => [new UserFileController(), 'download'],
    '/api/user-file-text' => [new UserFileController(), 'textPreview'],
    '/api/user-file-preview' => [new UserFileController(), 'preview'],
  ...
  'POST' => [
    ...
    '/api/admin/bizdev' => [new AdminController(), 'bizDevCreate'],
    ...
    '/api/user-files-upload-text' => [new UserFileController(), 'uploadText'],

  ...
  container.innerHTML = `
    ...
    <form id="loginForm" class="space-y-4">
      ...
      <div class="relative w-full">
        ...
        <button type="button" id="toggleLoginPassword" class="absolute right-2 top-1/2 -translate-y-1/2 flex items-center justify-center text-gray-500 bg-transparent border-0 p-0 m-0 w-auto" style="width:auto;">
    ...
    <div class="mt-6">
      ...
      <form id="magicLinkForm" class="space-y-2">
        ...
        <button type="submit" class="text-purple px-4 py-2 rounded">Send Magic Link</button>
      </form>
    </div>

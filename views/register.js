  ...
  container.innerHTML = `
    <div class="max-w-md mx-auto px-4">
      ...
      <div class="relative w-full">
        ...
        <button type="button" id="toggleRegisterPassword" class="absolute inset-y-0 right-2 flex items-center justify-center text-gray-500 bg-transparent border-0 p-0 m-0" style="width:2rem;">
